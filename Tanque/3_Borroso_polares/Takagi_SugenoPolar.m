...
%TAKAGI_SUGENOMISO({Y1, ..., Yn}, {[U(1) ... U(N)]1, ..., {[U(1) ... U(N)]n}, format, Vb, FSetArg, FSetMod, c, parámetros lineales)
...
%   variables borrosas [argumento, módulo].
%
...
if ~iscell(Y)
    %% Si solo se ha hecho una simulación
